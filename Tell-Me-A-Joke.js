let JokeLIst = [
    ...
    " The doctor gave me one year to live, so I shot him with my gun The judge gave me 5 years Problem solved.",
    ...
    " What’s the difference between a baby and a sweet potato? About 40 calories.",
    ...
    " What's the last thing to go through a fly's head as it hits the windshield of a car going  mph? Its butt.",
    ...
    " Happy 0th birthday At last, you can live undisturbed by life insurance agents!",
    ...
    " I got a job at a library, but it only lasted 5 minutes Turns out, books about women’s rights shouldn’t go in the Sci-Fi / Fantasy section.",
...
function getRandomJoke() {
    let randomNum = Math.random() * JokeLIst.length + 1;
    randomNum = Number.parseInt(randomNum);
    var joke = JokeLIst[randomNum];
    document.getElementById("joke-para").innerHTML = joke;
}
